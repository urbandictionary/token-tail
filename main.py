...
@cli.command
@click.option('-n', '--token-count', default=100, help='Number of tokens to include in the output.')
@click.option('-m', '--model', default='gpt-4', help='GPT model to use for tokenization.')
